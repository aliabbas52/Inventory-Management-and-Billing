...
// CLASS NAME : Menu
// IT CONTROLLS OVER ALL THE FUNCTIONS
...
// CLASS NAME : Product
// IT CONTROLLS OVER ALL THE FUNCTIONS RELATED TO PRODUCT ITEMS
...
// CLASS NAME : Account
//  IT CONTROLLS OVER ALL THE FUNCTIONS RELATED TO MAKING BILL
...
cout<<"-------------------------------";
gotoxy(25,6) ;
cout<<"Project Report On Computer Shop";
gotoxy(25,7);
cout<<"-------------------------------";
gotoxy(26,9);
cout<<"******PROGRAMED BY*****";
gotoxy(26,11);
cout<<"------RISHAB GARG------"<<endl<<endl;
cout<<"                              Akshay Panday"<<endl<<endl;

cout<<"                         ******Class: XII-B******";
gotoxy(25,17);
cout<<"Enter In the shop(y/n) :";
ch1=getche();
if(ch1=='y'||ch1=='Y')
{
while (1)
...
<<"*************************************************************" ;
gotoxy(14,6) ;
cout <<"RKG COMPUTER SHOP-Complete Range of Computer Peripherls" ;
gotoxy(14,7) ;
cout <<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" ;
gotoxy(30,9) ;
...
// THIS FUNCTION RETURNS THE CODE OF THE LAST RECORD IN THE PRODUCT FILE (PRODUCT.DAT).


int product :: last_code(void)
{
fstream file ;
file.open("PRODUT.DAT", ios::in) ;
...
cout <<"LIST OF ITEMS" ;
gotoxy(3,4) ;
cout <<"ITEM CODE      ITEM NAME      ITEM M.R.P       ITEM PRICE" ;
gotoxy(2,5) ;
cout <<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" ;
while (file.read((char *) this, sizeof(product)))
{
...
if (itemname[0] == '0')
return ;
if ((strlen(itemname) < 1) || (strlen(itemname) > 200))
{
valid = 0 ;
gotoxy(3,24) ;
cout <<"\7 Range = 1..20" ;
...
gotoxy(1,25) ; clreol() ;
gotoxy(3,25) ;
cout <<"ENTER ITEM M.R.P TO ADD IN THE MENU" ;
gotoxy(5,10) ;
cout <<"Item M.R.P : " ;
gets(t_itemcost) ;
...
if (t_itemprice[0] == '0')
return ;
if (itemprice > itemcost || itemprice > 9000)
{
valid = 0 ;
gotoxy(3,24) ;
...
itemcode = tcode ;
fstream file ;
file.open("PRODUT.DAT", ios::out | ios::app ) ;
...
getch() ;
fstream file ;
file.open("PRODUT.DAT", ios::out | ios::ate) ;
int location ;
...
billno = t_billno ;
fstream file ;
file.open("BIL.DAT", ios::out | ios:: app ) ;
...
cout <<"------------------" ;
gotoxy(8,9) ;
cout <<"Item code  Item name          M.R.P     Price     Qty      Total"
;
gotoxy(8,10) ;
cout <<"------------------------------------------------------------"
;
...
cout <<"LIST OF BILLS" ;
gotoxy(3,4) ;
cout <<"Billno.  Date    Item Code     Item name      M.R.P    Price   Qty       Total" ;
gotoxy(3,5) ;
cout
<<"===========================================================================" ;
while (file.read((char *) this, sizeof(account)))
...
menu m ;
m.main_menu() ;
//cout<<"Project By:- Rishab Garg"<<"Akshay Panday";
}
